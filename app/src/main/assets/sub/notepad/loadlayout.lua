...
local LuaDrawable=luajava.bindClass "com.StarVase.diaryTodo.app.LuaDrawable"
local LuaBitmapDrawable=luajava.bindClass "com.StarVase.diaryTodo.app.LuaBitmapDrawable"
local LuaAdapter=luajava.bindClass "com.StarVase.diaryTodo.app.LuaAdapter"
...
local function checkattr(s)
  return checkAndroidAttr(s) or checkAttr(s)
end
...
local function setattribute(root,view,params,k,v,ids)
  ...
  elseif k=="pages" and type(v)=="table" then --创建页项目
    ...
    local pagerAdapter=bindClass("com.StarVase.diaryTodo.ui.adapter.BasePagerAdapter")(views)
