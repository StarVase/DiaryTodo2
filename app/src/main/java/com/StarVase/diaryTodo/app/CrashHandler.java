...
public final class CrashHandler {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new UncaughtExceptionHandler(){
                ...
                private void tryUncaughtException(Thread thread, Throwable throwable) {
                    ...
                    File crashFile = new File(TextUtils.isEmpty(crashDir) ? new File(app.getExternalFilesDir(null), "crash")
                                              : new File(crashDir), "Dtd_Crash_" + time + ".log");
                    ...
                    sb.append("CPU Architecture   : ").append(Build.CPU_ABI).append("&&").append(Build.CPU_ABI2).append("\n");
                    sb.append("CPU Model          : ").append(Build.HARDWARE).append("\n");
    ...
    public static final class CrashActiviy extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setTheme(R.style.mDefaultWhite);
