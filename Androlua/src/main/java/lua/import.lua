...
local function env_import(env)
    ...
    append(packages, 'com.StarVase.diaryTodo.app.')
...
local LuaAsyncTask = luajava.bindClass("com.StarVase.diaryTodo.app.LuaAsyncTask")
local LuaThread = luajava.bindClass("com.StarVase.diaryTodo.app.LuaThread")
local LuaTimer = luajava.bindClass("com.StarVase.diaryTodo.app.LuaTimer")
